      ...
      {isEditing ? (
        <div className="space-y-2">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <button onClick={handleSaveEdit} disabled={saving} className="text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 disabled:opacity-50">
              <Check size={16} />
            </button>
          </div>
        </div>
